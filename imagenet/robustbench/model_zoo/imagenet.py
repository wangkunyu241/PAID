...
common_corruptions = OrderedDict(
    [
        ...
        ('Standard_VITB', {
            'model': lambda: timm.create_model("vit_base_patch16_224", pretrained=False, checkpoint_path="./assets/vit_base_patch16_224.augreg_in21k_ft_in1k/pytorch_model.bin"),
            'gdrive_id': '',
            'preprocessing': 'Res256Crop224'
        }),
        ('Standard_VITB_MAE', {
            'model': lambda: create_model_mae("vit_base_patch16_224", pretrained=False),
            'gdrive_id': '',
            'preprocessing': 'Res256Crop224'
        }),
        ('Standard_VITB_Ours', {
            'model': lambda: ViT_Ours(),
            'gdrive_id': '',
            'preprocessing': 'Res256Crop224'
        }),
    ])
